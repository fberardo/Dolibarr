...
/**
 *      \file       supplier_account_movement/supplieraccountmovement_script.php
...
// Examples for manipulating class supplieraccountmovement_class
require_once(DOL_DOCUMENT_ROOT."/../supplier_account_movement/supplieraccountmovement.class.php");
$myobject=new supplieraccountmovement($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."supplieraccountmovement";
