...
/**
 *      \file       supplier_account/supplieraccount_script.php
...
// Examples for manipulating class supplieraccount_class
require_once(DOL_DOCUMENT_ROOT."/../supplier_account/supplieraccount.class.php");
$myobject=new supplieraccount($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."supplieraccount";
