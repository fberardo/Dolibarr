...
ALTER TABLE llx_supplier_account ADD INDEX idx_supplier_account_fk_societe (fk_societe);

ALTER TABLE llx_supplier_account ADD UNIQUE INDEX uk_supplier_account (fk_societe);

ALTER TABLE llx_supplier_account ADD CONSTRAINT fk_supplier_account_fk_societe FOREIGN KEY (fk_societe) REFERENCES llx_societe (rowid);
