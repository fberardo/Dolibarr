...
/**
 *      \file       customer_account/customeraccount_script.php
...
// Examples for manipulating class customeraccount_class
require_once(DOL_DOCUMENT_ROOT."/../customer_account/customeraccount.class.php");
$myobject=new customeraccount($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."customeraccount";
