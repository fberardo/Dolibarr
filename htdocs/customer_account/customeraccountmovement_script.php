...
/**
 *      \file       customer_account_movement/customeraccountmovement_script.php
...
// Examples for manipulating class customeraccountmovement_class
require_once(DOL_DOCUMENT_ROOT."/../customer_account_movement/customeraccountmovement.class.php");
$myobject=new customeraccountmovement($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."customeraccountmovement";
