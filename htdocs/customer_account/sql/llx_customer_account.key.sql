...
ALTER TABLE llx_customer_account ADD INDEX idx_customer_account_fk_societe (fk_societe);

ALTER TABLE llx_customer_account ADD UNIQUE INDEX uk_customer_account (fk_societe);

ALTER TABLE llx_customer_account ADD CONSTRAINT fk_customer_account_fk_societe FOREIGN KEY (fk_societe) REFERENCES llx_societe (rowid);
