...
/**
 * \file    customer_account/customeraccount.class.php
...
class customeraccount extends CommonObject
{
	 ...
	 */
	public $element = 'customeraccount';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'customer_account';

	/**
	 * @var customeraccountLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("customeraccount", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $url = DOL_URL_ROOT.'/customer_account/'.$this->table_name.'_card.php?id='.$this->id;
